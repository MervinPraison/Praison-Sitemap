		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by <a href="https://mer.vin/">Mervin</a>'s <a href="https://mer.vin/seo-wordpress/">WordPress SEO plugin</a>. This is an XML Sitemap, to be used by search engines.<br/>
						You could get more information about XML sitemaps on <a href="http://sitemaps.org">sitemaps.org</a>.
					</p>					
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="<?php echo 'sitemaps.xml' ?>">&#8593; Sitemap Index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
									<th width="75%">URL</th>
